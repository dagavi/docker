...
Simple image containing a self-builded StrongSwan 5.9.0 with images for Linux 86_64 and ARM (for Raspberry Pi 2, for example) and  XL2TPd (to enable the possibility of making L2TP/IPSec tunnels).
